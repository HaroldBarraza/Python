...
#========================================================================================================
def water_column_height(tank_height, tower_height):
    height_water_column = tank_height + ((3 * tower_height)/(4))
...
def pressure_loss_from_pipe_reduction(larger_diameter,fluid_velocity, reynolds_number, smaller_diameter):
    ...
    pressure_loss_reduction = (- constant * 998.2 *(fluid_velocity**2))/(2000)
